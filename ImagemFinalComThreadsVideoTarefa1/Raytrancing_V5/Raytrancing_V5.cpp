...
int main() {
    ...
    for (int frame = 0; frame < num_frames; ++frame) {
        double theta = 2.0 * pi * frame / num_frames;
    ...
    std::string filename = "C:\\Users\\roger\\OneDrive\\Documentos\\Faculdade\\8periodo\\topicosEspeciais2\\testImagem\\test_frame_" + std::to_string(frame) + ".bmp";
